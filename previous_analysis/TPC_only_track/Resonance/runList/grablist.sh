...
#streaming production 1000 events per DST
#CreateDstList.pl DST_STREAMING_EVENT_run2pp --cdb 2024p002 --build new --list ${filename}
#streaming production 10000 events per DST
#CreateDstList.pl DST_STREAMING_EVENT_run2pp --cdb 2024p007 --build ana441 --list ${filename}
...
#CreateDstList.pl DST_TRKR_CLUSTER_run2pp --cdb 2024p007 --build ana.441 --list ${filename}

#tracking seed production
#CreateDstList.pl DST_TRKR_SEED_run2pp --cdb 2024p007 --build new --list ${filename}

#tracking track production
#CreateDstList.pl DST_TRKR_TRACKS_run2pp -cdb 2024p007 --build ana.441 --list ${filename}


#calo production 10000 events per DST in caloy2calib
CreateDstList.pl DST_CALO_run2pp --cdb 2024p007 --build ana437 --list ${filename}
