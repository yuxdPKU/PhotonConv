...
void plot()
{
    ...
    //chain->Add("/sphenix/u/xyu3/workarea/PhotonConv/TPC_only_track/Resonance/Ks/Reconstructed/*_ks.root");
    chain->Add("/sphenix/u/xyu3/workarea/PhotonConv/TPC_only_track/Resonance/Ks/analysis/allkfp.root");
...
/*
    ...
    TH2* h2_mass_DIRA = new TH2F("h2_mass_DIRA","",30,0.3,1,200,-1,1);
    chain->Draw("K_S0_DIRA:K_S0_mass>>h2_mass_DIRA");
    ...
    chain->Draw("track_1_pseudorapidity>>h1_track1_eta","");
    ...
    chain->Draw("track_1_phi>>h1_track1_phi","");
