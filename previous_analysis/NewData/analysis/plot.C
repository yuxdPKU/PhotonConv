...
void plot()
{
    ...
    chain->Add("../Reconstructed/eop_all_kfparticle.root");
    ...
    TH1* h1_rxy = new TH1F("h1_rxy","",100,0,150);
    ...
    TH2* h2_mass_rxy = new TH2F("h2_mass_rxy","",30,0.3,1,50,0,100);
    //TH2* h2_mass_rxy = new TH2F("h2_mass_rxy","",30,0.3,1,50,0,20);
    ...
    chain->Draw("K_S0_pT:K_S0_mass>>h2_mass_pt","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    ...
    chain->Draw("K_S0_pseudorapidity>>h1_eta","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    ...
    chain->Draw("K_S0_pseudorapidity:K_S0_mass>>h2_mass_eta","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    ...
    chain->Draw("track_1_pseudorapidity>>h1_track1_eta","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    makecanvas1d(h1_track1_eta,Form("figure/track_1_pseudorapidity.pdf"),Form("Ks track1 #eta"),Form("Counts"));

    TH2* h2_mass_track1eta = new TH2F("h2_mass_track1eta","",30,0.3,1,50,-1.1,1.1);
    chain->Draw("track_1_pseudorapidity:K_S0_mass>>h2_mass_track1eta","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    makecanvas2d(h2_mass_track1eta,Form("figure/track_1_mass_pseudorapidity.pdf"),Form("Ks mass [GeV]"),Form("Ks track1 #eta"));

    TH1* h1_track2_eta = new TH1F("h1_track2_eta","",100,-1.1,1.1);
    chain->Draw("track_2_pseudorapidity>>h1_track2_eta","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    makecanvas1d(h1_track2_eta,Form("figure/track_2_pseudorapidity.pdf"),Form("Ks track2 #eta"),Form("Counts"));

    TH2* h2_mass_track2eta = new TH2F("h2_mass_track2eta","",30,0.3,1,50,-1.1,1.1);
    chain->Draw("track_2_pseudorapidity:K_S0_mass>>h2_mass_track2eta","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    makecanvas2d(h2_mass_track2eta,Form("figure/track_2_mass_pseudorapidity.pdf"),Form("Ks mass [GeV]"),Form("Ks track2 #eta"));

    TH2* h2_track1eta_track2eta = new TH2F("h2_track1eta_track2eta","",50,-1.1,1.1,50,-1.1,1.1);
    chain->Draw("track_2_pseudorapidity:track_1_pseudorapidity>>h2_track1eta_track2eta","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    makecanvas2d(h2_track1eta_track2eta,Form("figure/track_12_pseudorapidity.pdf"),Form("Ks track1 #eta"),Form("Ks track2 #eta"));

    TH1* h1_phi = new TH1F("h1_phi","",100,-3.15,3.15);
    chain->Draw("K_S0_phi>>h1_phi","");
    ...
    TH2* h2_mass_dl = new TH2F("h2_mass_dl","",30,0.3,1,50,0,10);
    ...
    TH1* h1_Ks_track1_IPxy= new TH1F("h1_Ks_track1_IPxy","",100,0,20);
    ...
    TH2* h2_mass_track1_IPxy = new TH2F("h2_mass_track1_IPxy","",30,0.3,1,50,0,20);
    ...
    TH1* h1_Ks_track2_IPxy= new TH1F("h1_Ks_track2_IPxy","",100,0,20);
    ...
    TH2* h2_mass_track2_IPxy = new TH2F("h2_mass_track2_IPxy","",30,0.3,1,50,0,20);
    ...
    TH2* h2_mass_DIRA = new TH2F("h2_mass_DIRA","",30,0.3,1,50,-1,1);
    chain->Draw("K_S0_DIRA:K_S0_mass>>h2_mass_DIRA","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    makecanvas2d(h2_mass_DIRA,Form("figure/K_S0_mass_DIRA.pdf"),Form("Ks mass [GeV]"),Form("Ks DIRA"));

    TH1* h1_DIRA_xy = new TH1F("h1_DIRA_xy","",100,-1,1);
    chain->Draw("K_S0_DIRA_xy>>h1_DIRA_xy","");
    makecanvas1d(h1_DIRA_xy,Form("figure/K_S0_DIRA_xy.pdf"),Form("Ks DIRAxy"),Form("Counts"));

    TH2* h2_mass_DIRA_xy = new TH2F("h2_mass_DIRA_xy","",30,0.3,1,50,-1,1);
    chain->Draw("K_S0_DIRA_xy:K_S0_mass>>h2_mass_DIRA_xy","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    makecanvas2d(h2_mass_DIRA_xy,Form("figure/K_S0_mass_DIRA_xy.pdf"),Form("Ks mass [GeV]"),Form("Ks DIRAxy"));
    ...
    TH2* h2_mass_DCA = new TH2F("h2_mass_DCA","",30,0.3,1,50,0,0.5);
    ...
    TH1* h1_DCAxy = new TH1F("h1_DCAxy","",100,0,0.05);
    ...
    TH1* h1_mass = new TH1F("h1_mass","",100,0.3,1.0);
    //chain->Draw("K_S0_mass>>h1_mass","");
    //chain->Draw("K_S0_mass>>h1_mass","K_S0_DIRA>0.95");
    chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20");
    //chain->Draw("K_S0_mass>>h1_mass","2 <= K_S0_decayLength && K_S0_decayLength <= 10 && K_S0_DIRA_xy >= 0.7 && min(abs(track_1_IP_xy), abs(track_2_IP_xy)) >= 0.7");
    //chain->Draw("K_S0_mass>>h1_mass","0.5 <= K_S0_decayLength && K_S0_decayLength <= 10 && K_S0_DIRA_xy <= 0.9 && K_S0_DIRA_xy >= 0.7 && min(abs(track_1_IP_xy), abs(track_2_IP_xy)) >= 0.7");
    //chain->Draw("K_S0_mass>>h1_mass","K_S0_DIRA_xy <= 0.9 && K_S0_DIRA_xy >= 0. && min(abs(track_1_IP_xy), abs(track_2_IP_xy)) >= 0.7");
    //chain->Draw("K_S0_mass>>h1_mass","K_S0_DIRA_xy <= 0.9 && K_S0_DIRA_xy >= 0. && max(abs(track_1_IP_xy), abs(track_2_IP_xy)) <= 2");
    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<10 && K_S0_DIRA_xy <= 0.9 && K_S0_DIRA_xy >= 0.7 && min(abs(track_1_IP_xy), abs(track_2_IP_xy)) >= 2");
    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<10 && K_S0_DIRA <= 0.9 && K_S0_DIRA >= 0.0 && min(abs(track_1_IP_xy), abs(track_2_IP_xy)) >= 1 && K_S0_decayLength/K_S0_decayLengthErr>100");

    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20 && K_S0_phi>0.2 && K_S0_phi<0.4");
    //chain->Draw("K_S0_mass>>h1_mass","K_S0_phi>0.2 && K_S0_phi<0.4");
    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20 && (K_S0_pseudorapidity>-0.5 && K_S0_pseudorapidity<0)");
    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20 && (K_S0_pseudorapidity>0.5 && K_S0_pseudorapidity<0.8)");
    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20 && (K_S0_pseudorapidity<-0.3 || K_S0_pseudorapidity>0)");
    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)<20 && (track_1_pseudorapidity<-0.3 || track_1_pseudorapidity>0.3) && (track_2_pseudorapidity<-0.3 || track_2_pseudorapidity>0.3)");
    //chain->Draw("K_S0_mass>>h1_mass","sqrt(K_S0_x*K_S0_x+K_S0_y*K_S0_y)>3 && (track_1_pseudorapidity>-0.2 && track_1_pseudorapidity<0.2) && (track_2_pseudorapidity>-0.2 && track_2_pseudorapidity<0.2)");
