...
*/
  ...
  Fun4AllInputManager *infile0 = new Fun4AllDstInputManager("DSTin_0");
  //infile0->fileopen("DST_STREAMING_EVENT_run2pp_new_2024p002-00052519-00099.root");
  infile0->fileopen("DST_STREAMING_EVENT_run2pp_new_2024p002-00052519-00100.root");
  se->registerInputManager(infile0);

  Fun4AllInputManager *infile1 = new Fun4AllDstInputManager("DSTin_1");
  //infile1->fileopen("DST_CALO_run2pp_ana437_2024p007-00052519-00000.root");
  infile1->fileopen("DST_CALO_run2pp_ana437_2024p007-00052519-00001.root");
  se->registerInputManager(infile1);
