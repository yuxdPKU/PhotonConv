...
void EoP_kfp_v2(int runnumber=15)
{
  int verbosity = 0;
  ...
  chain->Add(Form("../15_new/TrackCalo_0_ana.root"));
  ...
  float teop_ep_pt, teop_ep_eta, teop_ep_phi, teop_ep_pE, teop_ep_phi_corr;
  float teop_em_pt, teop_em_eta, teop_em_phi, teop_em_pE, teop_em_phi_corr;
...
cout<<"ep px = "<<_true_ep_px->at(icant)<<" py = "<<_true_ep_py->at(icant)<<" pz = "<<_true_ep_pz->at(icant)<<" pE = "<<_true_ep_pE->at(icant)<<endl;
cout<<"em px = "<<_true_em_px->at(icant)<<" py = "<<_true_em_py->at(icant)<<" pz = "<<_true_em_pz->at(icant)<<" pE = "<<_true_em_pE->at(icant)<<endl;
cout<<"gamma px = "<<_true_gamma_px->at(icant)<<" py = "<<_true_gamma_py->at(icant)<<" pz = "<<_true_gamma_pz->at(icant)<<" pE = "<<_true_gamma_pE->at(icant)<<endl;
    }
