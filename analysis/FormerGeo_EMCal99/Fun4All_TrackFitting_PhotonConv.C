    ...
    const bool convertSeeds = false)
{
  ...
  float new_cemc_rad = 99; // Virgile recommendation according to DetailedCalorimeterGeometry
  ...
  cgm->set_UseDetailedGeometry(false);
  ...
  tcm->setRawTowerGeomContName("TOWERGEOM_CEMC");
  ...
  ttc->setRawTowerGeomContName("TOWERGEOM_CEMC");
